...
public class InclusiveOrExpNode extends ExpressionNode {

	public ExpressionNode left_d;
	public ExpressionNode right_d;

	public InclusiveOrExpNode(ExpressionNode left, ExpressionNode right) {
		left_d = left;
		right_d = right;
	}
	...
	public Type typeCheck(SymbolTable stable) throws TypeCheckError {
		...
		MethodType ptype = lookupPrimop(stable, Operators.INC_OR, 
	...
	public BranchHandle translateSynthesized(ClassGen classGen, MethodGen methodGen) {
		...
		patch = il.append(left_d.type().OR());
		if (gotor != null) {
