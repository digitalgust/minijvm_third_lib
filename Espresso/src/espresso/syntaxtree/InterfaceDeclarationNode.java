...
public class InterfaceDeclarationNode extends TypeDeclarationNode {

	public InterfaceDeclarationNode() {
		super();

		/* Default */
		accessFlags_d = (Constants.ACC_INTERFACE | Constants.ACC_ABSTRACT);
	}
	...
	public void translate() {
		...
		ClassGen classGen = new ClassGen(name_d.toInternalString(), "java.lang.Object",
			fileName, accessFlags_d, interfaces);
		...
		try {
			...
			clazz.dump(pathName + name_d + ".class");
		}
