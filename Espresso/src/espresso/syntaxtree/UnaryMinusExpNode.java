...
public class UnaryMinusExpNode extends ExpressionNode {

	public ExpressionNode left_d;

	public UnaryMinusExpNode(ExpressionNode left) {
		left_d = left;
	}

	public BigDecimal evaluate(SymbolTable stable) throws NotConstant {
		return left_d.evaluate(stable).negate();
	}		

	public Type typeCheck(SymbolTable stable) throws TypeCheckError {
		Type tleft  = left_d.typeCheck(stable);

		MethodType ptype = lookupPrimop(stable, Operators.UN_MS, 
