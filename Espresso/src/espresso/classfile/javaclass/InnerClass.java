    ...
    implements Constants
{
   ...
   */
    public final String toString (ConstantPool constant_pool) {
        ...
        inner_class_name =  constant_pool.getConstantString(inner_class_index, CONSTANT_Class);
        inner_class_name =  Utility.compactClassName(inner_class_name);
        outer_class_name =  constant_pool.getConstantString(outer_class_index, CONSTANT_Class);
        outer_class_name =  Utility.compactClassName(outer_class_name);
        inner_name =  ((ConstantUtf8)constant_pool.getConstant(inner_name_index, CONSTANT_Utf8)).getBytes();
