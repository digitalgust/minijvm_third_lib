 ...
 * <A href ="DE.fub.inf.JVM.JavaClass.JavaClass.html">
    ...
    implements Constants
{
   ...
   */
    public ClassParser (InputStream file, String file_name) {
        ...
        this.file =  (DataInputStream)file; else this.file =  new DataInputStream(new BufferedInputStream(file));
    }
   ...
   */
    ...
    {
        this.file_name =  file_name;
        file =  new DataInputStream(new BufferedInputStream(new FileInputStream(file_name)));
    }
   ...
   */
        ...
        throws IOException, ClassFormatError
    {
        ...
        return  new JavaClass(class_name_index, superclass_name_index, file_name, major, minor, access_flags, constant_pool, interfaces, fields, methods, attributes);
    }
   ...
   */
     ...
     */
        if ((access_flags & ACC_INTERFACE) != 0) access_flags |=  ACC_ABSTRACT;
        if (((access_flags & ACC_ABSTRACT) != 0) && ((access_flags & ACC_FINAL) != 0)) throw  new ClassFormatError("Class can't be both final and abstract");
   ...
   */
        ...
        throws IOException, ClassFormatError
    {
        ...
        if (file.readInt() != magic) throw  new ClassFormatError(file_name + " is not a Java .class file");
    }
   ...
   */
        ...
        throws IOException, ClassFormatError
    {
        ...
        if ((minor > MINOR) || (major > MAJOR)) throw  new ClassFormatError("Incompatible version: " + major + "." + minor);
    }
