    ...
    implements espresso.classfile.Constants
{
        ...
        throws IOException
    {
        ...
        if (attr_count%2 == 0) file.print("<TR BGCOLOR=\"#C0C0C0\"><TD>"); else file.print("<TR BGCOLOR=\"#A0A0A0\"><TD>");
        ...
        switch (tag) {
            case ATTR_CODE:
                ...
                if (len > 0) {
                    ...
                    for (int i =  0; i < len; i++) {
                        ...
                        file.print("<LI>");
                        if (catch_type != 0) file.print(constant_html.referenceConstant(catch_type)); // Create Link to _cp.html
            ...
            case ATTR_LOCAL_VARIABLE_TABLE:
                ...
                for (int i =  0; i < vars.length; i++) {
                    ...
                    file.println("<LI>" + Class2HTML.referenceType(signature) + "&nbsp;<B>" + vars[i].getName() + "</B> in slot %" + vars[i].getSlot() + "<BR>Valid from lines " + "<A HREF=\"" + class_name + "_code.html#code" + method_number + "@" + start + "\" TARGET=Code>" + start + "</A> to " + "<A HREF=\"" + class_name + "_code.html#code" + method_number + "@" + end + "\" TARGET=Code>" + end + "</A></LI>");
                }
